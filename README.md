...
- `/start` — для непривязанного пользователя объяснение Turbo Rating и три
  ...
  Для зарегистрированного — главный экран с текущим топом, своим рейтингом
  и местом, без повторного знакомства.
...
также начинает диалог привязки; `/add <ID или ссылка>` подключает сразу.
